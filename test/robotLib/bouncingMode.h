...
class BouncingMode
{
  ...
  private:
         ...
         double m_omega3;
          ...
          const double s_sin0          = 0.0;  //1.0 при 90
          const double s_cos0          = 1.0;  //0.0 при 90
          const double s_SPEED          = 200.0;
          const double s_CIRCLINGSPEED  = 100.0;
          const double s_PI             = 3.14159265358979;
          const double s_L              = 125.0;                //Distance from robot center to whell center in mm;
          const double s_RW             = 80.0;                 //Radius of the wheels in mm.  //80
