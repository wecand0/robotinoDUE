...
{
  m_omega1 = ( (((-s_SPEED * s_cos0 * s_sqrt3of2) + (s_SPEED * s_sin0 * 0.5)) / s_RW)  * s_PRM);
}
/*
...
{
  m_omega2 = ( ((-s_SPEED * s_sin0) / s_RW) * s_PRM);
}
...
{
  m_omega3 = ( ((s_SPEED * s_cos0 * s_sqrt3of2  + s_SPEED * s_sin0 * 0.5) / s_RW)  * s_PRM);
}
